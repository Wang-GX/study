...
public class ChainOfResponsibilityTest {
    public static void main(String[] args) {
        ...
        JdkDynamicProxyInterface proxy1 = (JdkDynamicProxyInterface)jdkDynamicProxyChainOfResponsibility.bind(new JdkDynamicProxyTarget(), "com.wgx.study.project.反射_动态代理.dynamicProxy.Interceptor1");
        //创建JdkDynamicProxyTarget对象的代理对象proxy2
        JdkDynamicProxyInterface proxy2 = (JdkDynamicProxyInterface)jdkDynamicProxyChainOfResponsibility.bind(proxy1,"com.wgx.study.project.反射_动态代理.dynamicProxy.Interceptor2");
        //创建JdkDynamicProxyTarget对象的代理对象proxy3
        JdkDynamicProxyInterface proxy3 = (JdkDynamicProxyInterface)jdkDynamicProxyChainOfResponsibility.bind(proxy1,"com.wgx.study.project.反射_动态代理.dynamicProxy.Interceptor3");
        proxy3.sayHello();
 ...
 * 基于jdk实现动态代理的类
 */
class JdkDynamicProxyChainOfResponsibility implements InvocationHandler {
