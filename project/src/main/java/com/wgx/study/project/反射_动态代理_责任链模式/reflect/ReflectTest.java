package com.wgx.study.project.反射_动态代理_责任链模式.reflect;
...
public class ReflectTest {
    public static void main(String[] args) throws Exception {
        ...
        Class<?> studentClass = Class.forName("com.wgx.study.project.反射_动态代理_责任链模式.reflect.Student");
        Class<?> codingClass = Class.forName("com.wgx.study.project.反射_动态代理_责任链模式.reflect.Coding");
